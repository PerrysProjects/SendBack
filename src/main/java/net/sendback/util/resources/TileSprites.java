...
public class TileSprites {
    ...
    public TileSprites(BufferedImage texture) {
    ...
    public TileSprites(BufferedImage texture, BufferedImage leftSideTexture, BufferedImage rightSideTexture, BufferedImage topSideTexture, BufferedImage bottomSideTexture,
