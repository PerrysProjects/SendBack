...
public class NoodleNoise {
    ...
    public static double noise(double x, double y, double z, int size, double seed) {
        double value = 0.0;
        double initialSize = size;

        while(size >= 1) {
            value += smoothNoise((x / size), (y / size), (z / size), seed) * size;
            size /= 2.0;
        }
    ...
    private static double smoothNoise(double x, double y, double z, double seed) {
        x += seed;
        y += seed;
        x += seed;
